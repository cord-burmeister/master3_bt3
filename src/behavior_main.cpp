...
int main(int argc, char * argv[])
{
  ...
  auto node = rclcpp::Node::make_shared("behavior_node");
  ...
  factory.registerFromPlugin(loader.getOSName("br2_saysomething_bt_node"));
  

  std::string pkgpath = ament_index_cpp::get_package_share_directory("master3_bt3");
  std::string xml_file = pkgpath + "/behavior_trees/patrolling.xml";
  //std::string xml_file = pkgpath + "/behavior_trees/saysomething.xml";
